...
export default class WalletGenerator extends HTMLElement{
	...
	// 	lightwallet.keystore.createVault({ password: password, seedPhrase: seed},
	// 	function (err, ks)
	// 	{
	...
	// 						const balance = parseInt(address, 16);
	// 						try
	// 						{
	...
	// 						list.innerHTML = this.generateAddrListItem(address, private_key, balance);
	// 	    		}
	// 	    	}
	// 	  	});
	// 	});
	...
	// }
  //
	// generateListItemEl(address, privKey, balance)
	// {
